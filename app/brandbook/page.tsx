      ...
      <section className="py-16 px-6 border-t border-white/10">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-gray-400 text-sm mb-4">
            Todo esse sistema visual vive em uma infraestrutura confiável. Para
            hospedar seu portfolio, landing pages ou projetos de cliente com
            performance e segurança, escolha uma stack que escala com você.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/5 text-white text-sm font-medium border border-white/10 hover:bg-white/10 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white text-black text-sm font-semibold hover:bg-gray-200 transition-colors"
            >
              <ExternalLink size={14} />
